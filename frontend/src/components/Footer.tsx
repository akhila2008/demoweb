...
export default function Footer() {
  return (
    <footer className="bg-black pt-16 pb-8 border-t border-[var(--color-primary)] border-opacity-30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-semibold text-[var(--color-primary)] mb-4">Shop</h4>
          ...
          {/* Support */}
          <div>
            <h4 className="text-lg font-semibold text-[var(--color-primary)] mb-4">Support</h4>
            <ul className="space-y-3 text-sm text-gray-300">
          ...
          {/* Newsletter */}
          <div>
            <h4 className="text-lg font-semibold text-[var(--color-primary)] mb-4">Newsletter</h4>
            <p className="text-sm text-gray-400 mb-4">Subscribe to receive updates, access to exclusive deals, and more.</p>
            <form className="flex flex-col sm:flex-row gap-2">
              <input 
                type="email" 
                placeholder="Enter your email" 
                className="px-4 py-2 bg-gray-900 text-white border border-[var(--color-primary)] border-opacity-50 rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)] flex-grow text-sm"
              />
              <button 
                type="submit" 
                className="bg-[var(--color-primary)] hover:bg-[#B3932F] text-black px-4 py-2 rounded-md transition-colors text-sm font-bold"
              >
                Subscribe
              </button>
            </form>

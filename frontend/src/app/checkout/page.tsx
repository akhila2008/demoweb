                    ...
                    <div className="bg-gray-900 text-white p-4 rounded border border-gray-200 dark:border-gray-700 flex flex-col md:flex-row gap-6">
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap gap-2 mt-4">
                          ...
                          <button onClick={() => { window.location.href = `upi://pay?pa=${storeSettings?.upiId || '8143227553@ybl'}&pn=AkhilaSarees&am=${grandTotal}&cu=INR`; handlePayment(); }} className="px-3 py-2 bg-green-100 text-green-800 hover:bg-green-200 dark:bg-green-900/30 dark:text-green-300 rounded text-sm font-medium transition-colors border border-[var(--color-primary)] border-opacity-30">Other App</button>
                        </div>

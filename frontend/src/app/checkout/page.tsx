                  ...
                  <div className="ml-8 p-4 bg-gray-50 dark:bg-gray-900 rounded-md border border-gray-200 dark:border-gray-800 space-y-4">
                    ...
                    <div className="bg-white dark:bg-black p-4 rounded border border-gray-200 dark:border-gray-700">
                      ...
                      <div className="flex flex-wrap gap-2 mt-3">
                        <button onClick={() => { window.location.href = `upi://pay?pa=${storeSettings?.upiId || 'akhilasarees@okhdfcbank'}&pn=AkhilaSarees&tr=ORD${Math.floor(Math.random() * 1000000)}&am=${grandTotal}&cu=INR`; handlePayment(); }} className="px-3 py-1.5 bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 rounded text-xs font-medium transition-colors">Google Pay</button>
                        <button onClick={() => { window.location.href = `upi://pay?pa=${storeSettings?.upiId || 'akhilasarees@okhdfcbank'}&pn=AkhilaSarees&tr=ORD${Math.floor(Math.random() * 1000000)}&am=${grandTotal}&cu=INR`; handlePayment(); }} className="px-3 py-1.5 bg-purple-100 text-purple-800 hover:bg-purple-200 dark:bg-purple-900/30 dark:text-purple-300 rounded text-xs font-medium transition-colors">PhonePe</button>
                        <button onClick={() => { window.location.href = `upi://pay?pa=${storeSettings?.upiId || 'akhilasarees@okhdfcbank'}&pn=AkhilaSarees&tr=ORD${Math.floor(Math.random() * 1000000)}&am=${grandTotal}&cu=INR`; handlePayment(); }} className="px-3 py-1.5 bg-blue-100 text-blue-800 hover:bg-blue-200 dark:bg-blue-900/30 dark:text-blue-300 rounded text-xs font-medium transition-colors">Paytm</button>
                        <button onClick={() => { window.location.href = `upi://pay?pa=${storeSettings?.upiId || 'akhilasarees@okhdfcbank'}&pn=AkhilaSarees&tr=ORD${Math.floor(Math.random() * 1000000)}&am=${grandTotal}&cu=INR`; handlePayment(); }} className="px-3 py-1.5 bg-green-100 text-green-800 hover:bg-green-200 dark:bg-green-900/30 dark:text-green-300 rounded text-xs font-medium transition-colors">Navi</button>
                      </div>
                    </div>

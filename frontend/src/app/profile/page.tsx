    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-1/4">
          <div className="bg-gray-900 text-white rounded-xl border border-[var(--color-primary)] border-opacity-30 shadow-sm p-6">
            <div className="flex flex-col items-center text-center border-b border-[var(--color-primary)] border-opacity-30 pb-6 mb-6">
              ...
              <p className="text-gray-200 text-xs mt-2">Member since {profileData?.joinDate}</p>
            </div>
            
            <nav className="space-y-2">
              <button className="w-full flex items-center gap-3 px-4 py-2 bg-gray-50 bg-gray-900 text-white rounded-lg text-white font-medium">
                <UserIcon className="w-5 h-5 text-[var(--color-primary)]" /> My Profile
              </button>
              <button className="w-full flex items-center gap-3 px-4 py-2 hover:bg-gray-50 dark:hover:bg-gray-900 rounded-lg text-gray-200 font-medium transition-colors">
        ...
        <div className="w-full md:w-3/4">
          <div className="bg-gray-900 text-white rounded-xl border border-[var(--color-primary)] border-opacity-30 shadow-sm p-6 sm:p-8">
            ...
            <div className="space-y-6 max-w-xl">
              <div>
                ...
                <input 
                  ...
                  readOnly 
                  className="w-full p-3 bg-gray-50 bg-gray-900 text-white text-white border border-[var(--color-primary)] border-opacity-50 rounded-lg"
                />
              </div>
              <div>

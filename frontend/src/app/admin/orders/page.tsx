    ...
    <div>
      ...
      <div className="bg-white dark:bg-[#121212] rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden">
        ...
        <div className="p-16 flex flex-col items-center justify-center text-center">
          ...
          <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-2">No orders placed yet</h2>
          <p className="text-gray-500 max-w-md">
            When customers place orders on your store, they will appear here. You can manage their fulfillment status and track revenue.
          </p>
        </div>

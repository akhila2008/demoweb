            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-black border-b border-[var(--color-primary)] border-opacity-30">
                  <th className="p-4 font-semibold text-gray-200 text-sm">Order ID</th>
                  <th className="p-4 font-semibold text-gray-200 text-sm">Date</th>
                  <th className="p-4 font-semibold text-gray-200 text-sm">Customer</th>
                  <th className="p-4 font-semibold text-gray-200 text-sm">Total</th>
                  <th className="p-4 font-semibold text-gray-200 text-sm">Payment</th>
                  <th className="p-4 font-semibold text-gray-200 text-sm">Status</th>
                  <th className="p-4 font-semibold text-gray-200 text-sm text-right">Action</th>
                </tr>
              </thead>
                  ...
                  return (
                    <div key={order.id} className="contents">
                      ...
                      <td className="p-4">
                        ...
                        <div className="text-xs text-gray-300">{d.customer?.email}</div>
                      </td>

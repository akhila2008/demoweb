    ...
    <div className="min-h-[80vh] flex items-center justify-center bg-gray-50 dark:bg-[#0a0a0a] px-4 py-12">
      <div className="bg-gray-900 text-white w-full max-w-md rounded-2xl shadow-xl border border-[var(--color-primary)] border-opacity-30 p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300">Join us to shop for premium sarees</p>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-5">
          <div>
            ...
            <div className="relative">
              <UserIcon className="w-5 h-5 text-gray-200 absolute left-3 top-1/2 -translate-y-1/2" />
              <input
                type="text"
                required
                value={name}
          ...
          <div>
            ...
            <p className="text-xs text-gray-300 mt-2">Must be at least 6 characters long</p>
          </div>
